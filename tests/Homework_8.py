...
class Homework_8(unittest.TestCase):
    ...
    def add_new_employee(self):
        ...
        # self.browser.find_element_by_id("firstName").send_keys("John")
        # self.browser.find_element_by_id("lastName").send_keys("Test")
        ...
        # self.browser.find_element_by_id("user_name").send_keys("John", "Test", employee_id)
        self.send_keys_to_field("user_name", ("John", "Test", employee_id))

        # self.browser.find_element_by_id("user_password").send_keys("Test", employee_id)
        # self.browser.find_element_by_id("re_password").send_keys("Test", employee_id)
