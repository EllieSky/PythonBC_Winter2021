...
class Api:
    ...
    def sign_in(self):
        ...
        return self.sess.post('http://hrm-online.portnov.com/symfony/web/index.php/auth/validateCredentials', headers=header, data=data)
    ...
    def delete_user(self, user_id):
        ...
        header = {'Content-Type': 'application/x-www-form-urlencoded'}
        return self.sess.post('http://hrm-online.portnov.com/symfony/web/index.php/admin/deleteSystemUsers', headers=header, data=data)